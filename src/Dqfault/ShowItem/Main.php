...
class Main extends PluginBase implements Listener {
    ...
    {
          if($this->config->get("showitem-disabled") == false) {
            if($command->getName() == "showitem") {
                if($sender instanceof Player) {

                    if ($sender->hasPermission("showitem.allow")) {

                        if(!isset($this->coolDownList[$sender->getName()])) {
                            $this->coolDownList[$sender->getName()] = time() + $this->config->get("showitem-cooldown-time");
                            ...
                            if($itemb->hasEnchantments()) {
                                if($sender->hasPermission("showitem.allow.enchants")){
                                    $this->getServer()->broadcastMessage(TextFormat::BOLD . TextFormat::GOLD . TextFormat::BOLD . TextFormat::BOLD . TextFormat::GOLD . TextFormat::BOLD . "$player " . TextFormat::BOLD . TextFormat::GREEN . "is showing off their" . TextFormat::BOLD . TextFormat::GREEN . TextFormat::GREEN . TextFormat::YELLOW . " $itemc " . TextFormat::GREEN . TextFormat::GREEN . TextFormat::RED . TextFormat::BOLD . "$item" . "\n" . TextFormat::GREEN . "$message");
            ...
            $sender->sendMessage($this->config->get("showitem-feature-disabled-message"));
        }
